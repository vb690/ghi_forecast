...
class TimeseriesAutoregressiveDataset(Dataset):
    """Dataset providing data for an autoregressive model
    in a streaming fashion. This is required for very large datasets.
    """
    ...
    def __len__(self):
        seq_len = (self._X.__len__() - (self._forecast_horizon + self._ar_window)) / self._gap
        return int(seq_len)
